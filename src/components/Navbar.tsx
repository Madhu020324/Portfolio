    ...
    <>
      <nav className="navbar">
        <div className="logo-container" onClick={openModal}>
          <img src="/src/assets/Madhu_Image.jpg" alt="Madhu Yamini Nallamothu" className="logo-img" />
        </div>
      ...
      {isModalOpen && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <img src="/src/assets/Madhu_Image.jpg" alt="Profile Full" className="full-image" />
          </div>
        </div>
      )}
    </>
